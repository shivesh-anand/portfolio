...
export const siteConfig = {
  name: "Shivesh Anand",
  description: "Shivesh Anand Portfolio Website",
  email: "theshiveshanand@gmail.com",
  images: {
    college:
      "https://res.cloudinary.com/dxiy3slnd/image/upload/v1735382777/bitmesra_fcz1t7.png",
  },
  links: {
