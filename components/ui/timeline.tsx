...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      ref={containerRef}
      className="w-full  dark:bg-neutral-950 font-sans md:px-10 overflow-hidden"
    >
      <div className="max-w-7xl mx-auto pt-20 px-4 md:px-8 lg:px-10">
        ...
        <p className=" dark:text-neutral-300 text-sm md:text-base">
          I&apos;m a fresher in the Software Development Industry. Here&apos;s a
          brief of my journey so far.
        </p>
      </div>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full e dark:bg-black flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-emerald-400 p-2" />
              </div>
        ...
        >
          <motion.div
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-emerald-400/0 via-emerald-400/90 to-emerald-400/0 from-[0%] via-[10%] rounded-full"
            style={{
